...
export class Backend {
    ...
    private formatEventItem(event: any): EventItem {
        return new EventItem(
            ...
            event.price ? event.price.label : null,
            event.price ? event.price.url : null,
            event.social ? event.social.twitter ? event.social.twitter.hashtag : null : null,
            event.social ? event.social.twitter ? event.social.twitter.account : null : null,
